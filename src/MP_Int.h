...
public:
  ...
  // convert internal value to unsigned or signed long
    inline operator unsigned long ( void ) const { return mpz_get_ui( value() ); };
    inline operator   signed long ( void ) const  { return mpz_get_si( value() ); };
