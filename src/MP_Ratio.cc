...
//
//  Copyright (C) 1993-2000, John A. Kassebaum
//
...
const MP_Int MP_Ratio::One = MP_Int( (unsigned long) 1 );
...
//template MP_Ratio abs( complex<MP_Ratio> const &);

////template MP_Ratio operator+(complex<MP_Ratio> const &, complex<MP_Ratio> const &);
////template MP_Ratio operator-( complex<MP_Ratio> const & );
//template MP_Ratio operator!=( complex<MP_Ratio> const &, complex<MP_Ratio> const & );
//template MP_Ratio operator*( complex<MP_Ratio> const &, complex<MP_Ratio> const & );
//template MP_Ratio operator==( complex<MP_Ratio> const &, complex<MP_Ratio> const & );

//template ostream &operator<<(ostream &, complex<MP_Ratio> const &);
//template MP_Ratio operator/(complex<MP_Ratio> const &, complex<MP_Ratio> const &);
